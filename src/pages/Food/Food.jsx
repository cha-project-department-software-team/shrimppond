...
function Food() {
    ...
    // State to manage data for each pond
    const [pondData, setPondData] = useState({
        A1: {
            date: '',
            rows: [{ name: "", type: "", quantity: "" }],
            infoType: 'thucan', // Add a key for info type
        },
        A2: {
            date: '',
            rows: [{ name: "", type: "", quantity: "" }],
    ...
    // Separate state variables for "Thức ăn" and "Thuốc"
    ...
    // Determine labels and options based on the selected info type
                    ...
                    <div className="flex flex-col space-y-4">
                        <div className="flex space-x-4">
                            <div className="w-1/2">
                                ...
                                <input type="text" id="pondName" value={selectedPond} disabled className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                            </div>
                            <div className="w-1/2">
                        ...
                        <div className="flex space-x-4">
                            <div className="w-1/2">
                                ...
                                <div className="flex space-x-2">
                                    ...
                                    />
                                    <button onClick={handleAddName} className="text-white bg-blue-500 hover:bg-blue-600 px-2 py-1 rounded-md">+</button>
                                </div>
                            </div>
                            <div className="w-1/2">
                                ...
                                <div className="flex space-x-2">
                                    <input 
                                        ...
                                        className="block w-full bg-white border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                        />
                                        <button onClick={handleAddType} className="text-white bg-blue-500 hover:bg-blue-600 px-2 py-1 rounded-md">+</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-end mt-4">
                                <button onClick={handleAddRow} className="text-white bg-blue-500 hover:bg-blue-600 px-2 py-1 rounded-md">+ Thêm hàng</button>
                            </div>
